...
namespace CoreLib.Utilities.Validation.Extensions
{
    ...
    public static class ValidationServiceExtensions
    {
        ...
        {
            // バリデーターを登録
            services.AddSingleton<IValidator<string?>>(new StringValidator.Email());
            services.AddSingleton<IValidator<string?>>(new StringValidator.JapanesePostalCode());
            services.AddSingleton<IValidator<string?>>(new StringValidator.JapanesePhoneNumber());
