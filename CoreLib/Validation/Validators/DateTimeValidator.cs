...
namespace CoreLib.Utilities.Validation.Validators
{
    ...
    public class DateTimeValidator : IValidator<DateTime>
    {
        ...
        IValidator<DateTime> IValidator<DateTime>.WithMessage(string errorMessage)
        {
            return WithMessage(errorMessage);
        }

        IValidator<DateTime> IValidator<DateTime>.WithErrorCode(string errorCode)
        {
            return WithErrorCode(errorCode);
        }
