...
namespace CoreLib.Utilities.Serialization
{
    ...
    public static class SerializerFactory
    {
        ...
        {
            { DataFormat.Json, new Lazy<ISerializer>(() => new Formats.JsonSerializer()) },
            { DataFormat.Xml, new Lazy<ISerializer>(() => new Formats.XmlSerializer()) },
            { DataFormat.Binary, new Lazy<ISerializer>(() => new Formats.BinarySerializer()) },
            // 必要に応じて他のシリアライザーを追加
        };
