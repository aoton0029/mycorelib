...
namespace CoreLib.DataProcessors
{
    ...
    public partial class BackgroundDataProcessor : BackgroundService, IDataProcessor
    {
        ...
        {
            return KeySpecificDataProcessor.CreateAndStartProcessing(dataKey, processorCancellationToken);
        }
    ...
    public partial class BackgroundDataProcessor
    {
        public class BackgroundDataProcessorMonitor
        {
            ...
            public static BackgroundDataProcessorMonitor CreateAndStartMonitoring(SemaphoreSlim processorsLock, Dictionary<int, KeySpecificDataProcessor> dataProcessors, CancellationToken monitoringCancellationToken = default)
            {
